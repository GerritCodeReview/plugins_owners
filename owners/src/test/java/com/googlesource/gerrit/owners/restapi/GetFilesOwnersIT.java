...
public class GetFilesOwnersIT extends LightweightPluginDaemonTest {
  ...
  public void shouldReturnACorrectResponse() throws Exception {
    ...
    HashMap<String, List<Owner>> expectedResponseValue =
    ...
    assertThat(responseValue.values().stream().findFirst().get().get(0).getId())
        .isEqualTo(expectedResponseValue.values().stream().findFirst().get().get(0).getId());
    assertThat(responseValue.values().stream().findFirst().get().get(0).getName())
        .isEqualTo(expectedResponseValue.values().stream().findFirst().get().get(0).getName());
  }
