...
public class AlreadyApprovedByCopyConditionIT extends LightweightPluginDaemonTest {
  ...
  @Test
  public void shouldNotCopyApprovalWhenAllModifiedFilesAreOwnedButApproverIsNotUploader()
      throws Exception {
    Change.Id changeId =
        changeOperations
            .newChange()
  ...
  @Test
  public void shouldNotCopyApprovalWhenChangedFilesAreNotAllOwned() throws Exception {
    Change.Id changeId =
        changeOperations
            .newChange()
            .project(project)
