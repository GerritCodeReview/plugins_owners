...
public class AlreadyApprovedByCopyConditionIT extends LightweightPluginDaemonTest {
  ...
  public void shouldNotCopyApprovalWhenAutoOwnersApprovedIsInheritedFromParentOwners()
      throws Exception {
    String ownedFile = pushOwnersToRepository("inherited: true\n");
  ...
  private String pushOwnersToRepository(String ownersHeader) throws Exception {
  ...
  public void shouldCopyApprovalWhenChildOwnersStopsAutoOwnersApprovedInheritance()
      throws Exception {
    String ownedFile = pushOwnersToRepository("inherited: false\n");
