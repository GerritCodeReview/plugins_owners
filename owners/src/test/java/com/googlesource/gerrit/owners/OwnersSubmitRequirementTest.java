...
public class OwnersSubmitRequirementTest {
  ...
  @Test
  public void shouldResolveLabelToCodeReviewIfProjectHasCodeReviewLabelConfiguredAsRequired() {
    // given
    LabelType requiredVerified = verified();
    LabelType notRequiredLabel = label().setFunction(LabelFunction.NO_BLOCK).build();
    LabelType requiredCodeReview = codeReview();
    LabelTypes types =
        new LabelTypes(List.of(requiredVerified, notRequiredLabel, requiredCodeReview));
  ...
  @Test
  public void
      shouldResolveLabelToRequiredLabelIfProjectHasCodeReviewLabelConfiguredAsNotRequired() {
    // given
    LabelType notRequiredCodeReview =
        codeReview().toBuilder().setFunction(LabelFunction.NO_BLOCK).build();
    LabelType requiredLabel = label().setFunction(LabelFunction.MAX_NO_BLOCK).build();
    LabelTypes types = new LabelTypes(List.of(notRequiredCodeReview, requiredLabel));
  ...
  @Test
  public void
      shouldResolveLabelToCodeReviewIfProjectHasNoRequiredLabelsAndCodeReviewIsConfigured() {
    // given
    LabelType notRequiredLabel = label().setFunction(LabelFunction.NO_BLOCK).build();
    LabelType notRequiredCodeReview =
        codeReview().toBuilder().setFunction(LabelFunction.NO_BLOCK).build();
    LabelTypes types = new LabelTypes(List.of(notRequiredLabel, notRequiredCodeReview));
  ...
  @Test
  public void
      shouldResolveLabelToFirstConfiguredRequiredLabelIfProjectHasCodeReviewLabelConfiguredAsNotRequired() {
    // given
    LabelType notRequiredCodeReview =
        codeReview().toBuilder().setFunction(LabelFunction.NO_BLOCK).build();
    LabelType requiredLabel = label().setFunction(LabelFunction.MAX_NO_BLOCK).build();
    LabelType requiredVerified = verified();
    LabelTypes types =
        new LabelTypes(List.of(notRequiredCodeReview, requiredLabel, requiredVerified));
  ...
  @Test
  public void shouldResolveLabelToFirstConfiguredLabelIfProjectHasNoCodeReviewAndRequiredLabels() {
    // given
    LabelType notRequiredLabel = label().setFunction(LabelFunction.NO_BLOCK).build();
    LabelType notRequiredVerified =
        verified().toBuilder().setFunction(LabelFunction.NO_BLOCK).build();
    LabelTypes types = new LabelTypes(List.of(notRequiredLabel, notRequiredVerified));
  ...
  public void shouldOwnersLabelContainOnlyConfiguredLabel() {
    // when
    LabelTypes result =
        OwnersSubmitRequirement.ownersLabel(new LabelTypes(List.of(label().build())), LABEL_ID);
  ...
  public void shouldOwnersLabelBeEmptyIfNonExistingLabelIsConfigured() {
    // when
    LabelTypes result =
        OwnersSubmitRequirement.ownersLabel(new LabelTypes(List.of(codeReview())), LABEL_ID);
