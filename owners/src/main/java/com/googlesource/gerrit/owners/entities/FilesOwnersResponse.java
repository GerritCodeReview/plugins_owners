...
public class FilesOwnersResponse {
  ...
  private final Map<String, Set<GroupOwner>> filesApproved;

  public FilesOwnersResponse(
      Map<Integer, Map<String, Integer>> ownersLabels, Map<String, Set<GroupOwner>> files, Map<String, Set<GroupOwner>> filesApproved) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equal(files, that.files) && Objects.equal(ownersLabels, that.ownersLabels) && Objects.equal(filesApproved, that.filesApproved);
  }
  ...
  public String toString() {
    return "FilesOwnersResponse{" + "files=" + files + ", ownersLabels=" + ownersLabels + ", filesApproved=" + filesApproved + '}';
  }
}
