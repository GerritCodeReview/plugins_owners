...
public class AlreadyApprovedByOwnerOperand implements UserInOperandFactory {
  ...
  public static String FULL_OPERAND_NAME = String.format("%s_%s", OPERAND, "owners");

  @Inject
  AlreadyApprovedByOwnerOperand(GetFilesOwners getFilesOwners, DiffOperations diffOperations) {
  ...
  public Predicate<ApprovalContext> create(UserInPredicate.Field field) throws QueryParseException {
    return new AlreadyApprovedByOwnerPredicate(getFilesOwners, diffOperations, field);
  }
}
