...
public class PathOwnersTest extends ClassicConfig {
  ...
  public void testClassic() throws Exception {
    ...
    PathOwners owners =
        new PathOwners(accounts, repository, Optional.empty(), branch, patchList, EXPAND_GROUPS);
  ...
  public void testFileBasedOwnersUnexpanded() throws Exception {
    ...
    PathOwners owners =
        new PathOwners(
            accounts, repository, Optional.empty(), branch, patchList, DO_NOT_EXPAND_GROUPS);
  ...
  public void testDisabledBranch() throws Exception {
    ...
    PathOwners owners =
        new PathOwners(
            accounts, repository, Optional.empty(), Optional.empty(), patchList, EXPAND_GROUPS);
    Set<Account.Id> ownersSet = owners.get().get(CLASSIC_OWNERS);
