...
public class PluginSettings {
  ...
  private final boolean enableSubmitRule;
  ...
  public PluginSettings(PluginConfigFactory configFactory, @PluginName String ownersPluginName) {
    ...
    this.enableSubmitRule = globalPluginConfig.getBoolean("owners", "enableSubmitRule", false);
  }
  ...
  public boolean enableSubmitRule() {
