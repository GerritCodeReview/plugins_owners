...
public class ReviewerManager {
  ...
  @Inject
  public ReviewerManager(GerritApi gApi, Gerrit214OneOffRequestContext requestContext) {
    this.gApi = gApi;
  ...
  public void addReviewers(Change change, Collection<Account.Id> reviewers)
    ...
    try(Gerrit214ManualRequestContext ctx = requestContext.openAs(change.getOwner())) {
