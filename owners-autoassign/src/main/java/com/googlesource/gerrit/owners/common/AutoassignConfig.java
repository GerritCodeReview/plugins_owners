...
import com.googlesource.gerrit.owners.common.AutoassignConfigModule.AutoassignField;
...
public class AutoassignConfig {
  ...
  public AutoassignField autoAssignField(Project.NameKey projectKey) throws NoSuchProjectException {
    return cfg(projectKey).getEnum(PROJECT_CONFIG_AUTOASSIGN_FIELD, AutoassignField.REVIEWER);
  }
