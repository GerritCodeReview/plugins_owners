...
import com.googlesource.gerrit.owners.common.AutoassignConfigModule.AutoassignedReviewerState;
...
public class AutoassignConfig {
  ...
  public AutoassignedReviewerState autoassignedReviewerState(Project.NameKey projectKey)
      throws NoSuchProjectException {
    return cfg(projectKey)
        .getEnum(PROJECT_CONFIG_AUTOASSIGN_FIELD, AutoassignedReviewerState.REVIEWER);
  }
