...
public class GitRefListenerIT extends LightweightPluginDaemonTest {
  ...
  public static class TestModule extends AbstractModule {
    ...
    protected void configure() {
      bind(GitReferenceUpdatedListener.class).to(TestGitRefListener.class);
    }
  }

  @Test
  public void shouldNotProcessNoteDbOnlyRefs() {
    TestGitRefListener gitRefListener = getPluginInstance(TestGitRefListener.class);
    ...
    TestReferenceUpdatedEvent refUpdatedEvent =
        new TestReferenceUpdatedEvent(
