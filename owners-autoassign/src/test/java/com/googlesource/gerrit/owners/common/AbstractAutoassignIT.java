...
public abstract class AbstractAutoassignIT extends LightweightPluginDaemonTest {
  ...
  @Test
  public void shouldAutoassignUserWithGenericFallback() throws Exception {
    String ownerEmail = user.email();
    String owner2Email = user2.email();

    addOwnersToRepo("", NOT_INHERITED, "suffix", ".java", ownerEmail, "generic", ".*", owner2Email);
