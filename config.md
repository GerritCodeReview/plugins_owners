...
__NOTE: The `add_match_owner_approval` predicate would also honour the OWNER file
without matchers, giving, therefore, the possibility of having different ownership
criteria for different subdirectories. Example: /foo-dir/OWNER can define a
directory-based ownership while /bar-dir/OWNER can rely on matching rules.__
