...
```
  bazel-genfiles/@PLUGIN@/@PLUGIN@.jar
  bazel-genfiles/@PLUGIN-autoassign@/@PLUGIN@-autoassign.jar
...
Create a symboling link of the owners-common plugin to the Gerrit source code
directory.
...
```
  ...
  bazel-genfiles/plugins/@PLUGIN-autoassign@/@PLUGIN@-autoassign.jar
```
